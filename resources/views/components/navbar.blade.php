<nav class="fixed top-0 z-50 w-full">
    <div class="flex items-center justify-between w-full p-3 border px-5 md:px-14 border-1 bg-[#FAF8F3] drop-shadow-md">
        ...
        <div class="flex items-center justify-center gap-10 font-bold text-black text-md">
            ...
            <a href="/sellers" class="hidden md:block {{ (Request::is('sellers') or Request::is('sellers/*') and !Request::is('sellers/*/blogs/*')) ? 'text-[#89B53D]' : 'hover:text-[#89B53D]' }}">Toko</a>
            <a href="/blogs" class="hidden md:block {{ (Request::is('blogs') or Request::is('sellers/*/blogs/*')) ? 'text-[#89B53D]' : 'hover:text-[#89B53D]' }}">Blog</a>
