...
<div class="flex flex-col px-5 md:px-20 pt-10 gap-y-5">
  <div class="flex flex-col items-center justify-center gap-y-10">
    ...
    <div >
      <h1 class="text-2xl md:text-4xl text-center">Maaf tujuanmu Pencarian mu tidak ada</h1>
      <p class="text-xl md:text-2xl text-center mt-2"> Coba periksa lagi kata pencarian anda</p>
    </div>
